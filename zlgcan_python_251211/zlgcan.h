 ...
 * @return 执行结果状态
 */
ZCAN_RET_STATUS FUNC_CALL ZCAN_SetLINSchedule(CHANNEL_HANDLE channel_handle, const ZCAN_LIN_SCHED_TABLE *sched_tbl, UINT sched_tbl_num);
 ...
 * @return 执行结果状态
 */
ZCAN_RET_STATUS FUNC_CALL ZCAN_SetLINScheduleItemEnabled(CHANNEL_HANDLE channel_handle, UINT sched_tbl_idx , UINT item_idx, UINT enabled);
